...
inline void register_apis(pybind11::module_& m) {
    ...
    m.def("get_hccl_root_info",
          &deep_ep::ascend::runtime::get_hccl_root_info);
    ...
    cls.def("is_destroyed", &deep_ep::ascend::ElasticBuffer::is_destroyed)
       ...
       .def("get_dispatch_handle_snapshot",
            &deep_ep::ascend::ElasticBuffer::get_dispatch_handle_snapshot)
